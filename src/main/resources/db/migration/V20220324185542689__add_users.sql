CREATE SEQUENCE main.users_user_id_seq INCREMENT BY 1 START WITH 100;
COMMENT ON SEQUENCE main.users_user_id_seq IS 'Users Sequence.';

CREATE TABLE main.users
(
    user_id       INTEGER     DEFAULT nextval('main.users_user_id_seq'::regclass) NOT NULL,
